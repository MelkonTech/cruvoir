...
module.exports = __webpack_require__("A2eA");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  try {
    res.statusCode = 200;
    res.end(JSON.stringify(ramda__WEBPACK_IMPORTED_MODULE_0__["filter"](term => Boolean(term.term.match(/^product(Description|Title)\-/)))((await (await node_fetch__WEBPACK_IMPORTED_MODULE_1___default()('https://api.poeditor.com/v2/terms/list', {
      body: Object(_components_common_helpers__WEBPACK_IMPORTED_MODULE_2__[/* objectToFetchPostParams */ "s"])({
