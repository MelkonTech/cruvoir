...
module.exports = __webpack_require__("WzAc");
...
/* harmony import */ var raw_body__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("XhHU");
/* harmony import */ var raw_body__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(raw_body__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  const rawBody = await raw_body__WEBPACK_IMPORTED_MODULE_2___default()(req);

  if (req.headers['x-shopify-hmac-sha256'] !== crypto__WEBPACK_IMPORTED_MODULE_0___default.a.createHmac('sha256', process.env.SHOPIFY_WEBHOOK_SECRET).update(rawBody.toString('utf8'), 'utf8').digest('base64')) {
    res.statusCode = 403;
  ...
  const createTermResponse = await node_fetch__WEBPACK_IMPORTED_MODULE_1___default()('https://api.poeditor.com/v2/terms/add', {
    body: Object(_components_common_helpers__WEBPACK_IMPORTED_MODULE_3__[/* objectToFetchPostParams */ "s"])({
  ...
  const updateLanguageResponse = await node_fetch__WEBPACK_IMPORTED_MODULE_1___default()('https://api.poeditor.com/v2/languages/update', {
    body: Object(_components_common_helpers__WEBPACK_IMPORTED_MODULE_3__[/* objectToFetchPostParams */ "s"])({
      api_token: process.env.PO_API_TOKEN,
      data: JSON.stringify([{
        fuzzy: 0,
